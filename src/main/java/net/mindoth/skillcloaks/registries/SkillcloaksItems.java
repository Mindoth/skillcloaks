...
public class SkillcloaksItems {
    ...
    public static final RegistryObject<Item> AGILITY_HOOD = REGISTRY.register("agility_hood",
            () -> new AgilityHoodItem(HoodItem.MaterialHood.HOOD, ArmorItem.Type.HELMET,
